    ...
    <aside className="sidebar hidden w-[248px] shrink-0 border-r border-white/[.07] px-4 py-5 lg:flex lg:flex-col">
      ...
      <nav className="space-y-1" aria-label="Primary navigation">
       ...
       <div className="mt-auto rounded-xl border border-white/[.1] bg-white/[.04] p-4">
         ...
         <p className="mb-3 text-[10px] leading-relaxed text-[#858c87]">Good files deserve a good home. Share only what you’d use twice.</p>
      </div>
  ...
  return <div className="app-shell flex text-[#e7e9e0]">
    ...
    <main className="min-w-0 flex-1">
      ...
      <div className="mx-auto max-w-[1480px] px-4 py-7 sm:px-7 lg:px-10 lg:py-10">
       ...
       <div className="mt-10 grid gap-4 lg:grid-cols-[1.2fr_.8fr]"><div className="surface relative overflow-hidden rounded-2xl p-5 sm:p-6"><div className="absolute -right-10 -top-20 h-52 w-52 rounded-full border border-white/[.12]"></div><div className="absolute -right-2 -top-12 h-36 w-36 rounded-full border border-white/[.08]"></div><div className="relative max-w-[500px]"><div className="mb-3 flex items-center gap-2 text-[10px] font-bold uppercase tracking-[.14em] text-[#e6e8e4]"><ShieldCheck size={14} /> Moderated by humans</div><h3 className="font-display text-[23px] font-bold leading-tight tracking-[-.055em] text-[#e8ede1]">A smaller archive<br />with higher standards.</h3><p className="mt-3 text-[11px] leading-relaxed text-[#7f8981]">Every file is checked for usefulness, clear licensing, and a description that tells you what you’re actually getting.</p><button type="button" data-testid="button-learn-guidelines" onClick={handleGuidelines} className="mt-5 flex items-center gap-2 text-[10px] font-extrabold text-[#f0f1ed]">Read the guidelines <ArrowUpRight size={13} /></button></div></div><div className="surface-subtle rounded-2xl p-5"><div className="mb-5 flex items-center justify-between"><div><div className="eyebrow">Community pulse</div><h3 className="mt-2 font-display text-[18px] font-bold tracking-[-.04em]">The signal desk</h3></div><div className="grid h-9 w-9 place-items-center rounded-full bg-white/[.09] text-white"><Sparkles size={16} /></div></div><div className="space-y-4"><div className="flex items-center justify-between border-b border-white/[.06] pb-3"><span className="text-[10px] text-[#7b857d]">Files added this month</span><span data-testid="text-pulse-added" className="font-mono-ui text-[11px] text-[#dfe2de]">+642</span></div><div className="flex items-center justify-between border-b border-white/[.06] pb-3"><span className="text-[10px] text-[#7b857d]">Downloads, last 24h</span><span data-testid="text-pulse-downloads" className="font-mono-ui text-[11px] text-[#dfe2de]">1,304</span></div><div className="flex items-center justify-between"><span className="text-[10px] text-[#7b857d]">Archive health</span><span className="flex items-center gap-1.5 font-mono-ui text-[11px] text-[#dfe2de]"><span className="h-1.5 w-1.5 rounded-full bg-white"></span>steady</span></div></div></div></div>
      </div>
    </main>
